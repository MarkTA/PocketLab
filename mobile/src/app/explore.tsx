      ...
      <ThemedView style={styles.container}>
        ...
        <ThemedView style={styles.sectionsWrapper}>
          <Collapsible title="File-based routing">
            ...
            <ThemedText type="small">
              The layout file in <ThemedText type="code">src/app/_layout.tsx</ThemedText>{" "}
          ...
          <Collapsible title="Android, iOS, and web support">
            <ThemedView type="backgroundElement" style={styles.collapsibleContent}>
              <ThemedText type="small">
                ...
                version, press <ThemedText type="smallBold">w</ThemedText> in the terminal
          ...
          <Collapsible title="Images">
            <ThemedText type="small">
              For static images, you can use the <ThemedText type="code">@2x</ThemedText>{" "}
              and <ThemedText type="code">@3x</ThemedText> suffixes to provide files for
